...
-- não é key sensitive
-- o dbo é o sa (super adm)
-- usar o not null impede do valor ser nulo
-- o contraist faz a pk e o fk
...
/*
 CREATE DATABASE Aula01 -- criar um bd, para aparecer, dá F5 focando na pasta bd

 DROP DATABASE Aula01 -- apaga o bd
 */
...
INSERT INTO UF (cd_UF, nm_UF, abr_UF) VALUES (13,'Amazonas','AM')
INSERT INTO UF (cd_UF, nm_UF, abr_UF) VALUES (12,'Amapá','AP')
...
INSERT INTO UF (cd_UF, nm_UF, abr_UF) VALUES (26,'Pernanbuco','PE')
...
INSERT INTO UF (cd_UF, nm_UF, abr_UF) VALUES (36,'Tocantins','TO')
 ...
 vlr_AreaM2 DECIMAL (10,2), -- EXEMPLO: 99999999,99 (10 VALORES, 2 DECIMAIS)
...
/*
ALTER TABLE Municipio add qtde_habitantes bigint
ALTER TABLE Municipio alter column nm_municipio varchar (45)
ALTER TABLE Municipio DROP COLUMN qtde_habitantes
*/

-- DELETE FROM Municipio // remove tudo do municipio

INSERT INTO Municipio VALUES ('nome do municipio')
...
INSERT INTO BAIRRO VALUES ('centro', 34001)

-- avaliação, pegar um estado, colocar 5 municipios e 10 bairros, pode usar  IBGE para consultar